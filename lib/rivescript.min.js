...
return words.join(" ");}
return string;};RiveScript.prototype._strip_nasties=function(string){string=string.replace(/[^A-Za-z0-9 ]/g,"");return string;};RiveScript.prototype._escape_html=function(string){string=string.replace(/&/g,"&amp;");string=string.replace(/</g,"&lt;");string=string.replace(/>/g,"&gt;");string=string.replace(/"/g,"&quot;");return string;};RiveScript.prototype._clone=function(obj){if(obj===null||typeof(obj)!="object"){return obj;}
