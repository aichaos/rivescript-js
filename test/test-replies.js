...
// Reply Tests
//###############################################################################
export async function test_previous(test) {
  let bot;
...
export async function test_random(test) {
  let bot;
  bot = new TestCase(test, `
...
export async function test_continuations(test) {
  let bot;
  bot = new TestCase(test, `
		+ tell me a poem
...
export async function test_redirects(test) {
  let bot;
  bot = new TestCase(test, `
		+ hello
		- Hi there!
...
export async function test_conditionals(test) {
  let age;
  let age_q;
  let ages;
  let bot;
...
export async function test_embedded_tags(test) {
  let bot;
  bot = new TestCase(test, `
		+ my name is *
...
export async function test_set_uservars(test) {
  let bot;
  bot = new TestCase(test, `
		+ what is my name
...
export async function test_questionmark(test) {
  let bot;
  bot = new TestCase(test, `
		+ google *
...
export async function test_repeat(test) {
...
export async function test_reply_arrays(test) {
  let bot;
  bot = new TestCase(test, `
