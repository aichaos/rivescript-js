...
// Trigger Tests
//###############################################################################
export async function test_atomic_triggers(test) {
  let bot;
...
export async function test_wildcard_triggers(test) {
  let bot;
  bot = new TestCase(test, `
		+ my name is *
...
export async function test_alternatives_and_optionals(test) {
  let bot;
  bot = new TestCase(test, `
		+ what (are|is) you
		- I am a robot.
...
export async function test_trigger_arrays(test) {
  let bot;
  bot = new TestCase(test, `
...
export async function test_weighted_triggers(test) {
  let bot;
  bot = new TestCase(test, `
...
export async function test_empty_piped_arrays(test) {
...
export async function test_empty_piped_alternations(test) {
  let bot = new TestCase(test, ``);
...
export async function test_empty_piped_optionals(test) {
  let bot = new TestCase(test, ``);
...
export async function test_empty_piped_missing_arrays(test) {
  let bot;
