...
// Unicode Tests
//###############################################################################
export async function test_unicode(test) {
  let bot;
...
export async function test_wildcards(test) {
  let bot;
...
export function test_unicode_keyword(test) {
  let bot;
  bot = new TestCase(test, `
		? 你好
		- Matched 你好 keyword.
...
export async function test_punctuation(test) {
  let bot;
  bot = new TestCase(test, `
		+ hello bot
		- Hello human!
